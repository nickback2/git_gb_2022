...
Чтобы зачеркнуть текст необходимо обрамить его двойными волнами . Например, ~~вот так~~

Чтобы подчеркнуть текст нужно на пустой строке ввести 3 знака минус "-". Пример:
...
## Цитаты
Чтобы сделать цитату в тексте необходимо перед ним поставить знак (>) . Например, 
>вот так
